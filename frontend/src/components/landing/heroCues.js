...
function buildEvents(base) {
  ...
  return {
    bump20: {
      ...
      payload: { demo_url: '/hero/stills/bump20.jpg', caption: '20 weeks! 🌸' },
      reactions: {},
      comment_count: 0,
    },
    bump30: {
      id: 'hero-bump30',
      event_type: 'photo',
      occurred_at: at(-28 * DAY),
      payload: { demo_url: '/hero/stills/bump30.jpg', caption: '30 weeks' },
      reactions: {},
      comment_count: 0,
    },
    bump35: {
      id: 'hero-bump35',
      event_type: 'photo',
      occurred_at: at(-14 * DAY),
      payload: { demo_url: '/hero/stills/bump35.jpg', caption: '35 weeks!!!' },
      reactions: {},
      comment_count: 0,
    },
    bump40: {
      ...
      payload: { demo_url: '/hero/stills/bump40.jpg', caption: 'get this baby out of me! 😅' },
      reactions: {},
      comment_count: 0,
    },
    contractionLogged: {
...
export const HERO_CUES = [
  ...
  { t: 4.8, apply: (s, { ev }) => addEvent(s, ev.bump30) },
  { t: 5.2, apply: (s, { ev }) => addEvent(s, ev.bump35) },
  { t: 5.7, apply: (s, { ev }) => addEvent(s, ev.bump40) },
